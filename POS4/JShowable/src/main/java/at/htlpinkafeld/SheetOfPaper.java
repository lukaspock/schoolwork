...
import at.htlpinkafeld.Showable.Showable;
import at.htlpinkafeld.Showable.ShowableDefault;

public class SheetOfPaper implements Size , Comparable, Showable{
    private int format; //0=DIN A0, 1=DIN A1, 2=DIN A2, 3=DIN A3, 4=DIN A4
    private Showable showable = new ShowableDefault(this);
